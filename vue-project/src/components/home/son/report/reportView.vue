<template>
    <el-breadcrumb>
      ...
      <el-breadcrumb-item :to="{ path: '/Report'}">报告列表</el-breadcrumb-item>
        ...
        <el-table-column type="expand">
          <template #default="props">
            <el-form label-position="left" inline class="demo-table-expand">
              <el-row>
                <el-col>
                  <el-form-item label="用例名称:" style="width: 500px">
                ...
                <el-col>
                  <el-form-item label="实际结果" style="width: 500px">
                    ...
                    <div>
                      <json-viewer :value="JSON.parse(props.row.fact.text)" style="width: 500px"   :expand-depth=5></json-viewer>
  ...
  // 引用请求
  import { ReporDetail } from "../../../../utils/html.js";
  ...
  // 实时任务和定时任务测试报告为同一个
  const reportListR = reactive({"list": []});
  function getReportDetail() {
    ReporDetail(queryParam).then((res) => {
      if (res["data"]["code"] == 1) {
        // const res_data = JSON.stringify(res["data"]["data"])
        reportListR.list = res["data"]["data"]
